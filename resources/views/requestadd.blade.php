...
@section('content')
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Add Request</h3>
							</div>
						</div>
					</div>
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-md-6">
													...
													<input type="text" class="form-control m-input" name="rid" value="">
												</div>
												<div class="col-md-6">
													<label>Status:</label>
													<?php
				...
				success: function(data) {
					if(data.success)
					{
						swal({
							...
							if (result.value) {
								window.location.href=("{{route('requestlist')}}");
							}
						});
