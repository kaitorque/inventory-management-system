...
@section('content')
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Edit Purchase</h3>
							</div>
						</div>
					</div>
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-md-6">
													...
													<input type="text" class="form-control m-input" name="puid" value="{{$purchase[0]->purchases_id}}" disabled>
													<input type="hidden" class="form-control m-input" name="encpuid" value="<?php echo UserFunction::encrypt($purchase[0]->purchases_id); ?>">
												</div>
												<div class="col-md-6">
													<label>Description:</label>
													<textarea type="text" class="form-control m-input" name="desc">{{$purchase[0]->description}}</textarea>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<div class="col-md-6">
													<label>Created By:</label>
													<input type="text" class="form-control m-input" name="createdby" value="{{$purchase[0]->createdby}}" disabled>
												</div>
												<div class="col-md-6">
													<label>Created Date:</label>
													<input type="text" class="form-control m-input" name="createddate" value="{{$purchase[0]->fmcreated_date}}" disabled>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<div class="col-md-6">
													<label>Updated By:</label>
													<input type="text" class="form-control m-input" name="modifiedby" value="{{$purchase[0]->modifiedby}}" disabled>
												</div>
												<div class="col-md-6">
													<label>Last Updated:</label>
													<input type="text" class="form-control m-input" name="modifiedbydate" value="{{$purchase[0]->fmmodified_date}}" disabled>
												</div>
											</div>
