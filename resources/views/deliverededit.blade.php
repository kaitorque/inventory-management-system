...
@section('content')
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Edit Delivered</h3>
							</div>
						</div>
					</div>
										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-md-6">
													...
													<input type="text" class="form-control m-input" name="did" value="{{$delivered[0]->delivered_id}}" disabled>
													<input type="hidden" class="form-control m-input" name="encdid" value="<?php echo UserFunction::encrypt($delivered[0]->delivered_id); ?>">
												</div>
												<div class="col-md-6">
													<label>Status:</label>
													<?php
													...
													echo UserFunction::buildcbsort("status", $optionArr, $valueArr, $delivered[0]->status, "form-control m-input"); ?>
											...
											<div class="form-group m-form__group row">
												<div class="col-md-6">
													...
													<input type="text" class="form-control m-input" name="createdby" value="{{$delivered[0]->createdby}}" disabled>
												</div>
												<div class="col-md-6">
													<label>Created Date:</label>
													<input type="text" class="form-control m-input" name="createddate" value="{{$delivered[0]->fmcreated_date}}" disabled>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<div class="col-md-6">
													<label>Updated By:</label>
													<input type="text" class="form-control m-input" name="modifiedby" value="{{$delivered[0]->modifiedby}}" disabled>
												</div>
												<div class="col-md-6">
													<label>Last Updated:</label>
													<input type="text" class="form-control m-input" name="modifiedbydate" value="{{$delivered[0]->fmmodified_date}}" disabled>
												</div>
											</div>
